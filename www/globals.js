  ...
  function patchInteractionManager() {
    ...
    function extendMethod(method, extFn) {
      ...
      proto[method] = function () {
        old.call.apply(old, [this].concat(_slice.call(arguments)));
        extFn.call.apply(extFn, [this].concat(_slice.call(arguments)));
      };
    }
    ...
    // patch constructor
    // var Parent = PIXI.interaction.InteractionManager;
    // PIXI.interaction.InteractionManager = function(renderer, options) {
    //   Parent.apply(this, arguments);
    //   this.processTouchOverOut = this.processTouchOverOut.bind(this);
    // };

    // PIXI.interaction.InteractionManager.prototype = Parent.prototype;
  }
